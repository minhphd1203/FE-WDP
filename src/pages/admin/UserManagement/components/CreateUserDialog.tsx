...
import { CreateAccountFormData } from "../../../../schema/userSchema";
...
interface CreateUserDialogProps {
  ...
  setAvatarFilePreview: (url: string) => void;
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl border-[1px] border-red-400 pl-10 pr-3 text-base focus:ring-0 focus:outline-red-500"
                    {...register("password")}
                    placeholder="Ít nhất 8 ký tự, 1 hoa, 1 thường, 1 số, 1 ký tự đặc biệt"
                  />
                </div>
                {errors.password && (
                  <p className="text-sm text-red-600">
