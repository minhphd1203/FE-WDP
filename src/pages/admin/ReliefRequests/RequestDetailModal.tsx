  ...
  const handleEvaluate = async () => {
    try {
      ...
      queryClient.invalidateQueries({
        queryKey: ["rescue-request", request.id],
      });
      onUpdated?.();
      setActiveMode(null);
    } catch {
                ...
                <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
                  ...
                  <div className="space-y-4">
                          ...
                          ![
                            ...
                            <div className="grid grid-cols-3 gap-2">
                              <Button
                                ...
                                className={cn(
                                  activeMode === "evaluate"
                                    ? redPrimaryButtonClass
                                    : redOutlineButtonClass,
                                )}
                                onClick={() =>
                                  setActiveMode(
                                    activeMode === "evaluate"
                            ...
                            <div>
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem
                                    value={RescueRequestPriority.MEDIUM}
                                  >
                                    Trung bình
                                  </SelectItem>
                                  <SelectItem
                                    value={RescueRequestPriority.HIGH}
                                  >
                                    Cao
                                  </SelectItem>
                                  <SelectItem
                                    value={RescueRequestPriority.CRITICAL}
                                  >
                                    Khẩn cấp
                                  </SelectItem>
                                </SelectContent>
                          ...
                          <div className="space-y-3 rounded-lg border border-border bg-muted/30 p-3">
                            ...
                            <div className="max-h-60 space-y-2 overflow-y-auto pr-1">
                              {loadingTeams ? (
                                ...
                                teams.map((team: any) => {
                                  const selected = selectedTeamIds.includes(
                                    team.id,
                                  );
                                  return (
                                    <button
                          ...
                          <div className="space-y-3 rounded-lg border border-border bg-muted/30 p-3">
                            <div>
                              ...
                              >
                                ...
                                <SelectContent>
                                  {Object.values(RescueRequestStatus).map(
                                    (status) => (
                    ...
                    <div className="rounded-lg border border-border bg-muted/30 p-3 text-xs text-muted-foreground">
                      ...
                      <p className="mt-1">
                        Chọn một hành động ở trên, biểu mẫu sẽ mở ngay trong cột
                        phải để bạn xử lý trong khi vẫn nhìn thấy toàn bộ thông
                        tin yêu cầu ở cột trái.
                      </p>
                    </div>
                  </div>
                </div>
