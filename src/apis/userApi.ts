...
export const userApi = {
  ...
  getUsers: async (params?: Partial<PaginationParams> & {
    ...
    return httpClient.get<ApiResponse<PaginatedResponse<User>>>(ACCOUNT_ENDPOINTS.ACCOUNTS, { params });
  },

  // Get account by ID
  getUserById: async (id: string): Promise<ApiResponse<User>> => {
    return httpClient.get<ApiResponse<User>>(ACCOUNT_ENDPOINTS.ACCOUNT_BY_ID(id));
  },
  ...
  updateUser: async (
    ...
    return httpClient.patch<ApiResponse<User>>(ACCOUNT_ENDPOINTS.ACCOUNT_BY_ID(id), data);
  },

  // Delete account
  deleteUser: async (id: string): Promise<ApiResponse<void>> => {
    return httpClient.delete<ApiResponse<void>>(ACCOUNT_ENDPOINTS.ACCOUNT_BY_ID(id));
  },

  // Update account status
  updateUserStatus: async (id: string, data: UpdateAccountStatusDto): Promise<ApiResponse<User>> => {
    return httpClient.patch<ApiResponse<User>>(ACCOUNT_ENDPOINTS.ACCOUNT_STATUS(id), data);
  },

  // Confirm contact
  confirmContact: async (id: string): Promise<ApiResponse<void>> => {
    return httpClient.post<ApiResponse<void>>(ACCOUNT_ENDPOINTS.ACCOUNT_CONFIRM_CONTACT(id));
  },

  // Verify contact
  verifyContact: async (id: string, data: VerifyContactDto): Promise<ApiResponse<void>> => {
    return httpClient.post<ApiResponse<void>>(ACCOUNT_ENDPOINTS.ACCOUNT_VERIFY_CONTACT(id), data);
  },
};
